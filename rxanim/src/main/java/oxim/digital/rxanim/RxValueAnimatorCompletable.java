...
final class RxValueAnimatorCompletable extends Completable {

    private final ValueAnimator valueAnimator;
    private final Consumer<ValueAnimator> valueUpdateAction;

    RxValueAnimatorCompletable(final ValueAnimator valueAnimator, final Consumer<ValueAnimator> valueUpdateAction) {
    ...
    private static class Listener extends MainThreadDisposable implements ValueAnimator.AnimatorUpdateListener {
